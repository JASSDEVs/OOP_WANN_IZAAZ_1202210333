public class Laptop extends Perangkat{
    ...
    public void information(){
        if(webcam == true){
            System.out.println("Laptop "+ this.user+" memiliki drive tipe " + this.drive + " dengan RAM sebesar "+ this.ram + "GB dan processor secepat " + this.processor + "Ghz. Selain itu laptop ini memiliki Webcam");
        }else{
            System.out.println("Laptop "+ this.user+" memiliki drive tipe " + this.drive + " dengan RAM sebesar "+ this.ram + "GB dan processor secepat " + this.processor + "Ghz. Selain itu laptop ini TIDAK memiliki Webcam");
        }
    }
